...
def create_app(test_config=None):
    ...
    review_activity_scheduler.add_job(review_activity, trigger='cron', day_of_week='thu-sat', hour=review_activity_scheduler_hour, minute=review_activity_scheduler_min)
